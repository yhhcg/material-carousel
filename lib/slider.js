...
export default class Slider extends React.Component {
  ...
  onTouchStart(e) {
    ...
    this.preTranslateX = this.state.translateX;
  }
  ...
  onTouchMove(e) {
    ...
    this.setState({
      ...this.state,
      translateX: this.preTranslateX + distance,
      time: 0,
    });
  }
  ...
  moveEnd() {
   ...
   const {
    ...
    if (Math.abs(distance) >= this.sliderWidth / 2) {
      ...
      // Left to right
      if (distance > 0) {
        nextTranslateX = this.preTranslateX === - this.sliderWidth
          ? - this.sliderWidth * data.length
          : this.preTranslateX + this.sliderWidth;
      ...
      // Right to left
      if (distance < 0) {
        nextTranslateX = this.preTranslateX === - this.sliderWidth * data.length
          ? - this.sliderWidth * 1
          : this.preTranslateX - this.sliderWidth;
